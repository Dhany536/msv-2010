...
Public Class Form1
    ...
    Private Sub TextBox3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles N3.TextChanged

    End Sub

    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'EktpDataSet.ektp' table. You can move, or remove it, as needed.
        Me.EktpTableAdapter.Fill(Me.EktpDataSet.ektp)
        koneksi()
        da = New OleDbDataAdapter("SELECT * FROM ektp", conn)
        ds = New DataSet()
        ds.Clear()
    ...
    Private Sub TextBox1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles N1.KeyPress
        Dim pjkel As String
        Dim status As String
        N1.MaxLength = 12
        If e.KeyChar = Chr(13) Then
            Try
                cmd = New OleDbCommand("SELECT * FROM ektp WHERE nomorpd='" & N1.Text & "'", conn)
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles N1.TextChanged
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            ...
            If MessageBox.Show("yakin akan meng-edit nama E-KTP ???", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                ...
                Dim edit As String = "UPDATE ektp SET nama='" & N2.Text & "', tempat='" & N3.Text & "',tanggallahir='" & N4.Text & "', jkel='" & pjkel & "', alamat='" & N5.Text & "', email='" & N6.Text & "',provinsi='" & C1.Text & "',kota='" & N7.Text & "',kecamatan='" & N8.Text & "',agama='" & C2.Text & "',status='" & status & "' where nomorpd='" & N1.Text & "'"
